...
public class database
{
  ...
  public static void openBusDatabase()
  {
    try
    {
     /* String filename = "data.dat"; 
      ...
      busDatabase = new database("2014_comp23420_r4", 
                                 "mbax2ib2",
                                 "duombaze", 
  ...
  public int find_id(String id_field, String source, String field1, Object value1, String field2, Object value2, String field3, Object value3)
  {
    select(id_field, source, field1 + " = " + value_string(value1) + " And " + field2 + " = " + value_string(value2) + " And " + field3 + " = " + value_string(value3), "");
    if (move_first()) return (Integer)get_field(id_field);
    else return 0;
  }
